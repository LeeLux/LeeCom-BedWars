...
execute unless score bw.eightteams BedWars matches 1 as @a[tag=bw.invgui,tag=bw.invgui.page1] run function bw:invgui/page1/give4
...
execute if score bw.eightteams BedWars matches 1 as @a[tag=bw.invgui,tag=bw.invgui.page1] run function bw:invgui/page1/give8
