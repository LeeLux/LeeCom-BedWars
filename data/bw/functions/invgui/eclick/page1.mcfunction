...
#orange
execute unless entity @s[nbt={Inventory:[{Slot:1b}]}] run function bw:invgui/adv/orange
execute unless entity @s[nbt={Inventory:[{Slot:1b}]}] run function bw:invgui/reload
#yellow
execute unless entity @s[nbt={Inventory:[{Slot:2b}]}] run function bw:invgui/adv/yellow
execute unless entity @s[nbt={Inventory:[{Slot:2b}]}] run function bw:invgui/reload
#green
execute unless entity @s[nbt={Inventory:[{Slot:3b}]}] run function bw:invgui/adv/green
execute unless entity @s[nbt={Inventory:[{Slot:3b}]}] run function bw:invgui/reload
#blue
execute unless entity @s[nbt={Inventory:[{Slot:4b}]}] run function bw:invgui/adv/blue
execute unless entity @s[nbt={Inventory:[{Slot:4b}]}] run function bw:invgui/reload
#purple
execute unless entity @s[nbt={Inventory:[{Slot:5b}]}] run function bw:invgui/adv/purple
execute unless entity @s[nbt={Inventory:[{Slot:5b}]}] run function bw:invgui/reload
#white
execute unless entity @s[nbt={Inventory:[{Slot:6b}]}] run function bw:invgui/adv/white
execute unless entity @s[nbt={Inventory:[{Slot:6b}]}] run function bw:invgui/reload
#black
execute unless entity @s[nbt={Inventory:[{Slot:7b}]}] run function bw:invgui/adv/black
execute unless entity @s[nbt={Inventory:[{Slot:7b}]}] run function bw:invgui/reload
#next
execute unless entity @s[nbt={Inventory:[{Slot:8b}]}] run function bw:invgui/adv/pagenext
