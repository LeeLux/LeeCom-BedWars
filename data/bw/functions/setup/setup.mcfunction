...
scoreboard objectives add bw.enable.SingleplayerGame trigger
...
scoreboard objectives add bw.enable.alwaysActiveShop trigger
...
scoreboard objectives add bw.enable.useCustomShop trigger
scoreboard objectives add bw.shop.predi dummy
scoreboard objectives add bw.enable.shopReset trigger
scoreboard objectives add bw.enable.keepTeamAfterGameEnd trigger
scoreboard objectives add bw.updateShop trigger
scoreboard objectives add bw.enable.normalRegeneration trigger
scoreboard objectives add bw.timer dummy
scoreboard objectives add bw.setTimeUntilBedsGone trigger
scoreboard objectives add bw.enable.bedsGoneAfterTime trigger
scoreboard objectives add bw.setTimeUntilAutoDraw trigger
scoreboard objectives add bw.enable.autoDrawAfterTime trigger
...
scoreboard objectives add bw.disableDropResourcesOnDeath trigger
...
scoreboard objectives add bw.showStats trigger
