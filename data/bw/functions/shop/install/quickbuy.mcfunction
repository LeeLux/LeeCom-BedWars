...
#6 armor
data merge block 65536 250 65537 {Items: []}
data modify block 65536 250 65537 Items append from block 65541 250 65536 Items[{Slot: 0b}]
...
#6 armor
data merge block 65536 250 65537 {Items: []}
data modify block 65536 250 65537 Items append from block 65541 250 65536 Items[{Slot: 9b}]
