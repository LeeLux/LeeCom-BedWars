...
data modify block 65544 247 65536 Items[{Slot: 0b}].tag merge value {Tags: ["bw.resource.1"]}
data modify block 65544 247 65536 Items[{Slot: 1b}].tag merge value {Tags: ["bw.resource.2"]}
data modify block 65544 247 65536 Items[{Slot: 2b}].tag merge value {Tags: ["bw.resource.3"]}
data modify block 65544 247 65536 Items[{Slot: 3b}].tag merge value {Tags: ["bw.resource.4"]}