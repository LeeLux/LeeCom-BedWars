...
execute unless data entity @s Items[{Slot: 0b}] run function bw:shop/buyitems/page6/0b/check
execute unless data entity @s Items[{Slot: 1b}] run function bw:shop/buyitems/page6/1b/check
execute unless data entity @s Items[{Slot: 2b}] run function bw:shop/buyitems/page6/2b/check
execute unless data entity @s Items[{Slot: 3b}] run function bw:shop/buyitems/page6/3b/check
execute unless data entity @s Items[{Slot: 4b}] run function bw:shop/buyitems/page6/4b/check
execute unless data entity @s Items[{Slot: 5b}] run function bw:shop/buyitems/page6/5b/check
execute unless data entity @s Items[{Slot: 6b}] run function bw:shop/buyitems/page6/6b/check
execute unless data entity @s Items[{Slot: 7b}] run function bw:shop/buyitems/page6/7b/check
execute unless data entity @s Items[{Slot: 8b}] run function bw:shop/buyitems/page6/8b/check
#END#
...
execute if score @s bw.shop.update matches 1 run function bw:shop/reset/6
