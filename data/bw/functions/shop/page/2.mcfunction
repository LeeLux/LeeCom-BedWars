...
execute unless data entity @s Items[{Slot: 0b}] run function bw:shop/buyitems/page2/0b/check
execute unless data entity @s Items[{Slot: 1b}] run function bw:shop/buyitems/page2/1b/check
execute unless data entity @s Items[{Slot: 2b}] run function bw:shop/buyitems/page2/2b/check
execute unless data entity @s Items[{Slot: 3b}] run function bw:shop/buyitems/page2/3b/check
execute unless data entity @s Items[{Slot: 4b}] run function bw:shop/buyitems/page2/4b/check
execute unless data entity @s Items[{Slot: 5b}] run function bw:shop/buyitems/page2/5b/check
execute unless data entity @s Items[{Slot: 6b}] run function bw:shop/buyitems/page2/6b/check
execute unless data entity @s Items[{Slot: 7b}] run function bw:shop/buyitems/page2/7b/check
execute unless data entity @s Items[{Slot: 8b}] run function bw:shop/buyitems/page2/8b/check
#END#
...
execute if score @s bw.shop.update matches 1 run function bw:shop/reset/2
