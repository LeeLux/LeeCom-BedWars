...
execute unless data entity @s Items[{Slot: 0b}] run function bw:shop/buyitems/page7/0b/check
execute unless data entity @s Items[{Slot: 1b}] run function bw:shop/buyitems/page7/1b/check
execute unless data entity @s Items[{Slot: 2b}] run function bw:shop/buyitems/page7/2b/check
execute unless data entity @s Items[{Slot: 3b}] run function bw:shop/buyitems/page7/3b/check
execute unless data entity @s Items[{Slot: 4b}] run function bw:shop/buyitems/page7/4b/check
execute unless data entity @s Items[{Slot: 5b}] run function bw:shop/buyitems/page7/5b/check
execute unless data entity @s Items[{Slot: 6b}] run function bw:shop/buyitems/page7/6b/check
execute unless data entity @s Items[{Slot: 7b}] run function bw:shop/buyitems/page7/7b/check
execute unless data entity @s Items[{Slot: 8b}] run function bw:shop/buyitems/page7/8b/check
#END#
...
execute if score @s bw.shop.update matches 1 run function bw:shop/reset/7
