...
# ======================================================== #
execute as @p[tag=bw.shop.want] if score @s bw.bronce matches 8.. run give @s wooden_axe{CanPlaceOn: ["#place"], CanDestroy: ["#break.all"], HideFlags: 24, Enchantments: [{id: "minecraft:efficiency", lvl: 1s}]} 1
