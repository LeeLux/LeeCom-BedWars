...
# ======================================================== #
execute as @p[tag=bw.shop.want] if score @s bw.bronce matches 8.. run give @s stick{CanPlaceOn: ["#place"], CanDestroy: ["#break.all"], HideFlags: 24, display: {Name: '{"text":"Knockback Stick","italic":false}'}, Enchantments: [{id: "minecraft:knockback", lvl: 2s}]} 1
