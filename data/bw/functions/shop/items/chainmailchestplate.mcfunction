...
# ======================================================== #
execute as @p[tag=bw.shop.want] if score @s bw.silver matches 2.. run give @s chainmail_chestplate{CanPlaceOn: ["#place"], CanDestroy: ["#break.all"], HideFlags: 24, Enchantments: [{id: "minecraft:protection", lvl: 1s}]}
