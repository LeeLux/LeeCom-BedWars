...
# ======================================================== #
execute as @p[tag=bw.shop.want] if score @s bw.gold matches 10.. run give @s potion{CanPlaceOn: ["#place"], CanDestroy: ["#break.all"], HideFlags: 24, display: {Name: '{"text":"Jump Boost","italic":false}'}, CustomPotionEffects: [{Id: 8b, Amplifier: 2b, Duration: 1200}], CustomPotionColor: 655104}
