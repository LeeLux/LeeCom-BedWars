...
## Give Item Spawner
give @s pig_spawn_egg{display: {Name: '[{"text": "","color": "white","italic":false},{"text":"[BW] ","color":"green"},{"text":"Ressource Spawner 1 ","color":"white","italic":false},{"text":"(Bronce)","color":"red","italic":false}]'}, EntityTag: {id: "minecraft:armor_stand", NoGravity: 1b, Silent: 1b, Invulnerable: 1b, Marker: 1b, Invisible: 1b, NoBasePlate: 1b, Tags: ["bw.spawner.bronce", "bw.spawner", "bw.entity", "bw.rotadetoplayer"]}} 1

give @s evoker_spawn_egg{display: {Name: '[{"text": "","color": "white","italic":false},{"text":"[BW] ","color":"green"},{"text":"Ressource Spawner 2 ","color":"white","italic":false},{"text":"(Silver)","color":"gray","italic":false}]'}, EntityTag: {id: "minecraft:armor_stand", NoGravity: 1b, Silent: 1b, Invulnerable: 1b, Marker: 1b, Invisible: 1b, NoBasePlate: 1b, Tags: ["bw.spawner.silver", "bw.spawner", "bw.entity", "bw.rotadetoplayer"]}} 1

give @s camel_spawn_egg{display: {Name: '[{"text": "","color": "white","italic":false},{"text":"[BW] ","color":"green"},{"text":"Ressource Spawner 3 ","color":"white","italic":false},{"text":"(Gold)","color":"gold","italic":false}]'}, EntityTag: {id: "minecraft:armor_stand", NoGravity: 1b, Silent: 1b, Invulnerable: 1b, Marker: 1b, Invisible: 1b, NoBasePlate: 1b, Tags: ["bw.spawner.gold", "bw.spawner", "bw.entity", "bw.rotadetoplayer"]}} 1

give @s endermite_spawn_egg{display: {Name: '[{"text": "","color": "white","italic":false},{"text":"[BW] ","color":"green"},{"text":"Ressource Spawner 4 ","color":"white","italic":false},{"text":"(Platin)","color":"dark_gray","italic":false}]'}, EntityTag: {id: "minecraft:armor_stand", NoGravity: 1b, Silent: 1b, Invulnerable: 1b, Marker: 1b, Invisible: 1b, NoBasePlate: 1b, Tags: ["bw.spawner.platin", "bw.spawner", "bw.entity", "bw.rotadetoplayer"]}} 1
##END##
