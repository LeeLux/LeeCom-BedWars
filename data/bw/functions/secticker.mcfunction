...
#update sidebar#
execute if score bw.gamestate BedWars matches 1.. run function bw:sidebargame
execute if score bw.gamestate BedWars matches 0 run function bw:sidebarlobby
#END#

schedule function bw:secticker 1s