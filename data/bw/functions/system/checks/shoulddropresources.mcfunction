...
execute if entity @s[team=orange] unless score bw.upgrade.8 bw.upgrades.orange matches 2.. run function bw:system/dropresources
execute if entity @s[team=purple] unless score bw.upgrade.8 bw.upgrades.purple matches 2.. run function bw:system/dropresources
execute if entity @s[team=white] unless score bw.upgrade.8 bw.upgrades.white matches 2.. run function bw:system/dropresources
execute if entity @s[team=black] unless score bw.upgrade.8 bw.upgrades.black matches 2.. run function bw:system/dropresources