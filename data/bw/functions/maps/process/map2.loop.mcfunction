...
##clearing loop##
#loop#
execute as @e[tag=bw.clon.map2] at @s run clone ~ ~ ~ ~150 ~ ~150 0 ~ 0
execute as @e[tag=bw.clon.map2] at @s run clone ~ ~ ~ ~-150 ~ ~-150 -150 ~ -150
execute as @e[tag=bw.clon.map2] at @s run clone ~ ~ ~ ~-150 ~ ~150 -150 ~ 0
...
#END#
execute if entity @e[tag=bw.clon.map2,scores={bw.clear=320..}] run function bw:maps/process/end
execute as @e[tag=bw.clon.map2] at @s unless score @s bw.clear matches 320.. run schedule function bw:maps/process/map2.loop 1t
##END##