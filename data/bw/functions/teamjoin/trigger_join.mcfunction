...
execute as @a[scores={bw.join.orange=1..}] at @s run function bw:teamjoin/orange
execute as @a[scores={bw.join.purple=1..}] at @s run function bw:teamjoin/purple
execute as @a[scores={bw.join.white=1..}] at @s run function bw:teamjoin/white
execute as @a[scores={bw.join.black=1..}] at @s run function bw:teamjoin/black
