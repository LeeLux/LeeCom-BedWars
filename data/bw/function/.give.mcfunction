...
#give @s crimson_sign[custom_name='[{"text": "","color": "white","italic":false},{"text":"[BW] ","color":"green"},{"text":"Game Start","color":"white","italic":false}]',block_entity_data={Text1:"{\"text\":\"[Right click]\",\"color\":\"yellow\",\"clickEvent\":{\"action\":\"run_command\",\"value\":\"/trigger bw.gamestart\"}}",Text3:"{\"text\":\"to start the\",\"color\":\"white\"}",Text4:"{\"text\":\"Game!\",\"color\":\"yellow\"}"}] 1
