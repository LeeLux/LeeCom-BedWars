...
execute unless data entity @s Items[{Slot: 0b}] run function bw:shop/buyitems/page8/0b/check
execute unless data entity @s Items[{Slot: 1b}] run function bw:shop/buyitems/page8/1b/check
execute unless data entity @s Items[{Slot: 2b}] run function bw:shop/buyitems/page8/2b/check
execute unless data entity @s Items[{Slot: 3b}] run function bw:shop/buyitems/page8/3b/check
execute unless data entity @s Items[{Slot: 4b}] run function bw:shop/buyitems/page8/4b/check
execute unless data entity @s Items[{Slot: 5b}] run function bw:shop/buyitems/page8/5b/check
execute unless data entity @s Items[{Slot: 6b}] run function bw:shop/buyitems/page8/6b/check
execute unless data entity @s Items[{Slot: 7b}] run function bw:shop/buyitems/page8/7b/check
execute unless data entity @s Items[{Slot: 8b}] run function bw:shop/buyitems/page8/8b/check
#END#
